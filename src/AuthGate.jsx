...
export default function AuthGate({ children }) {
  ...
  return (
    <div>
      <div style={{ position: "fixed", top: 10, right: 14, zIndex: 1000 }} className="no-print">
        <button
          onClick={handleLogout}
          style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.15)", color: "#8B93A6", borderRadius: 6, padding: "5px 10px", fontSize: 11.5, cursor: "pointer" }}
        >
